...
export default function CheckOutWhenCustomerComeIn() {
  ...
  const luuThongTinGiangVienMua = async () => {
    ...
    try {
      ...
      console.log("Sau khi put ID giảng viên: ", response.data.UserID);
    ...
    <div className="p-4">
      ...
      <div className="flex flex-col gap-4">
        ...
        <input
          ...
          className="w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-2 px-4"
          value={soLuongBo}
          onChange={(e) => handleSoLuongBoChange(e)}
          name="quantity"
        />
        ...
        <button
          class="bg-blue-600 text-white font-mono py-2 px-4 w-[310px] rounded"
